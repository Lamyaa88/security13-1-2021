...
class PricingWhenNotLogedIn extends StatefulWidget {


  @override

  _PricingWhenNotLogedInState createState() => _PricingWhenNotLogedInState();

}

class _PricingWhenNotLogedInState extends State<PricingWhenNotLogedIn> {
        ...
        children: <Widget>[
          Column(
            ...
            children: <Widget>[
              ...
              Center(
                child: myText( "",redColor,height*.02) ,
              ),
