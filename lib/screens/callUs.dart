...
class _CallUsState extends State<CallUs> {
  ...
  getCustomMarker()async{
    customMarkerImage =  await BitmapDescriptor.fromAssetImage(
        ImageConfiguration.empty,'assets/logo.png');
  ...
  void _onMapCreated(GoogleMapController controller) {
    ...
    setState(() {
      markers.add(Marker(markerId: MarkerId("1"),position: LatLng(24.74476409009432, 46.70409900267053)
          ,infoWindow: InfoWindow(title: "الشيخ حسين بن حسن ،الواحة ، الرياض " )),);
    });
  }
