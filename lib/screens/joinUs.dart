...
//  }
  ...
  Future<dynamic>sendApplication(String HYEJU, String name, String Gender,
      String ID_NUM, String E_MAIL, String Mobile, String address  ,var cvFile ) async {
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) => Notifications6(
                                      userIdWillBeSentToNotificationsPage)),
                            );
                          },
                        ),
            ...
            children: <Widget>[
              InkWell(
                onTap: () async {
                  ...
                  sendApplication("1", "2","3", "4", "5", "6", "7", cvFile);
...
//                  final File cv = cvFile;
//
//                  final UserModel user = await createUser(
//                      HYEJU, name, ID_NUM, Gender, E_MAIL, Mobile, address, cv);
//
//                  setState(() {
//                    _user = user;
//                  });
