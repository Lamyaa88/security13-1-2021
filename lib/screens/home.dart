...
import 'myAccountWhenNotLoggedIn.dart';
import 'notificationsWhenNotLoggedIn.dart';
import 'pricingWhenNotLoggedIn.dart';
...
class _HomeState extends State<Home> {
  ...
  String savedId =
      "replaced with stored  user id _ if no id => there is no stored id   ";
  String savedEmail = "";
  String savedPassword =
      "replaced with stored user password  _ if no password  => there is no stored password  ";
  String savedName =
      "replaced with stored user name  _ if no password  => there is no stored name  ";
  String savedPhone =
      "replaced with stored user phone   _ if no password  => there is no stored phone   ";
                    ...
                    onPressed: () {
                      Navigator.push(
                          ...
                          SlideFromLeftPageRoute(
                              widget: userId == "1"
                                  ? NotificationsWhenNotLogedIn()
                                  : Notifications6(userId)));
                    },
                    color: whiteColor,
                  ),
                  SizedBox(
                    ...
                    onPressed: () {
                      Navigator.push(
                        ...
                        PageRouteBuilder(
                          ...
                          transitionsBuilder:
                              (context, animation5, animation2, child) {
                  ...
                  children: <Widget>[
                    iconBox(context, 'assets/user.png', () {
                      Navigator.of(context).pushReplacement(MaterialPageRoute(
                          builder: (BuildContext context) => userId == "1"
                              ? MyAccountWhenNotLoggedIn()
                              : MyAccount()));
                    }, 'حسابي'),
                    SizedBox(
                      width: width * .01,
