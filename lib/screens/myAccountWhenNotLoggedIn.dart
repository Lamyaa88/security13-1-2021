...
class MyAccountWhenNotLoggedIn extends StatefulWidget {


  @override

  _MyAccountWhenNotLoggedInState createState() => _MyAccountWhenNotLoggedInState();

}

class _MyAccountWhenNotLoggedInState extends State<MyAccountWhenNotLoggedIn> {
