...
class NotificationsWhenNotLogedIn extends StatefulWidget {


  @override

  _NotificationsWhenNotLogedInState createState() => _NotificationsWhenNotLogedInState();

}

class _NotificationsWhenNotLogedInState extends State<NotificationsWhenNotLogedIn> {
        ...
        children: <Widget>[
          Column(
            ...
            children: <Widget>[
              ...
              Center(
                child: myText( "لا يوجد اشعارات ",redColor,height*.02) ,
              ),
...
//                            onTap: ()  {
//                              Navigator.push(
//                                  context, SlideFromRightPageRoute(widget: Login()));
//
//                            },
